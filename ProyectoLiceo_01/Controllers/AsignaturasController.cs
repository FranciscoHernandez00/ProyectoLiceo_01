...
namespace ProyectoLiceo_01.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AsignaturaID,NombreAsignatura,Descripcion")] Asignaturas asignaturas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AsignaturaID,NombreAsignatura,Descripcion")] Asignaturas asignaturas)
        {
            if (ModelState.IsValid)
            {
